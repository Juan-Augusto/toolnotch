...
Antes de nada, convierte tus notas. Comparar un promedio de 8,0 con un requisito estadounidense de 3.0 no dice nada hasta que ambos estén en la misma escala. Si aún no lo has hecho, mira [Cómo Convertir Notas Brasileñas al GPA 4.0](/es/blog/convertir-notas-brasilenas-a-gpa) (el método vale para cualquier expediente en 0 a 10) o usa directamente la [Calculadora de GPA](/es/tools/education/gpa-calculator).
...
6. **Amplía la lista.** Postularse a 8 a 12 programas repartidos entre ambiciosos, probables y seguros es la práctica estándar en EE. UU., y es el cambio que más mejora las probabilidades reales de admisión.
