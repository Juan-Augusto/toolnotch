...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/tools/finance/va-loan-calculator' },
  openGraph: { title: variant.metaTitle, description: variant.metaDescription, url: '/tools/finance/va-loan-calculator' },
}

export default function VaLoanCalculatorPage() {
  const jsonLd = buildJsonLd(
    webAppSchema(variant.title, '/tools/finance/va-loan-calculator', variant.description, 'FinanceApplication'),
    faqSchema(variant.faqs),
    breadcrumbSchema([
      { name: 'Home', url: '/' },
      { name: 'Finance Tools', url: '/tools/finance' },
      { name: variant.title, url: '/tools/finance/va-loan-calculator' },
    ]),
  )
  return (
    <>
