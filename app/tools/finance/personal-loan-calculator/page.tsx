...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/tools/finance/personal-loan-calculator' },
  openGraph: { title: variant.metaTitle, description: variant.metaDescription, url: '/tools/finance/personal-loan-calculator' },
}

export default function PersonalLoanCalculatorPage() {
  const jsonLd = buildJsonLd(
    webAppSchema(variant.title, '/tools/finance/personal-loan-calculator', variant.description, 'FinanceApplication'),
    faqSchema(variant.faqs),
    breadcrumbSchema([
      { name: 'Home', url: '/' },
      { name: 'Finance Tools', url: '/tools/finance' },
      { name: variant.title, url: '/tools/finance/personal-loan-calculator' },
    ]),
  )
  return (
    <>
