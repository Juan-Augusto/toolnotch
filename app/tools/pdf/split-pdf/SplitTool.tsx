...
const faqs = [
  {
    ...
    answer:
      "Upload your PDF, enter the page ranges you want (e.g. 1-3, 4-6), and click Split PDF. Each range downloads as a separate PDF inside a ZIP file.",
  },
  {
    question: "Can I extract a single page?",
    answer: "Yes — enter the same page number for start and end, e.g. 5-5.",
  },
  {
    question: "Are my files sent to a server?",
    answer: "No. Everything runs in your browser. Your files stay on your device.",
  },
  {
    question: "How do I know how many pages my PDF has?",
    answer:
      "Open the PDF in any viewer (like your browser or Adobe Reader) to see the total page count.",
  },
];
...
export default function SplitPDFPage() {
  ...
  return (
    <ToolWrapper
      ...
      description="Extract pages or split a PDF into multiple files. No upload needed."
    ...
    >
      ...
      <div className="mb-4">
        ...
        />
        <p className="text-xs text-gray-400 mt-1">Leave blank to extract all pages individually.</p>
      </div>

      {error && <p className="text-red-600 text-sm mb-3">{error}</p>}
      {done && <p className="text-green-600 text-sm mb-3">Split PDF(s) downloaded!</p>}
