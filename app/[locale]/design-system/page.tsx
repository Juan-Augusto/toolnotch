      ...
      <header style={{ borderBottom: "1px solid var(--base-border)" }}>
        <div className="max-w-4xl mx-auto px-6 py-14">
          <div className="flex flex-wrap items-center gap-2 mb-5">
            ...
            <span className="">Surgical Neon</span>
          </div>
          <h1
          ...
          <div className="mt-8 flex flex-wrap gap-6">
            ...
            <div>
              <div className="">Display font</div>
              <div
      ...
      <div className="max-w-4xl mx-auto px-6 py-14 space-y-0">
        <Section title="Color System">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className=" p-6">
              <div className=" mb-5">Surfaces (dark mode)</div>
              <div className="space-y-4">
                ...
                <Swatch
                  label="--base-border"
                  value="#1c1c36"
                  style={{ background: "#1c1c36" }}
                />
              </div>
            </div>

            <div className=" p-6">
              <div className=" mb-5">Neon accent</div>
              <div className="space-y-4">
                <Swatch
                  label="--neon (dark)"
                  value="#00e5a0"
            ...
            <div className=" p-6">
              <div className=" mb-5">Typography colors</div>
              <div className="space-y-4">
                <Swatch
                  label="--text-primary"
                  value="#e8e8f6"
                  style={{ background: "#e8e8f6" }}
                />
                <Swatch
                  label="--text-secondary"
                  value="#8e8eb6"
                  style={{ background: "#8e8eb6" }}
                />
                <Swatch
                  label="--text-muted"
                  value="#4e4e72"
                  style={{ background: "#4e4e72" }}
                />
              </div>
            </div>
            ...
            <div className=" p-8 space-y-6">
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-primary)" }}
                >
                  Base (1rem): Free online tools that run entirely in your
                  browser. No sign-up required, no data sent to any server. Your
                  files stay private.
                </p>
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  Small (0.875rem): Secondary text, descriptions, helper copy.
                  Used for supporting information that doesn&apos;t need full
                  prominence.
                </p>
                <p
                  ...
                  style={{ color: "var(--text-muted)" }}
                >
                  XSmall (0.75rem): Labels, captions, metadata, timestamps.
                  Lowest level of the text hierarchy.
                </p>
              </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className=" p-6 flex flex-wrap gap-4 items-center">
                ...
                <button className="btn-neon" disabled>
                  Disabled
                </button>
            ...
            <div>
              ...
              <div className=" p-6 flex flex-wrap gap-3 items-center">
                <span className="">Privacy secured</span>
                ...
                <span
                  ...
                  style={{
                    color: "#ff3366",
                    background: "rgb(255 51 102 / 0.07)",
                    borderColor: "rgb(255 51 102 / 0.3)",
                  }}
                >
                  Danger
                </span>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className=" p-5">
                  <div className=" mb-2">Static card</div>
                  <p
                    className="text-sm"
                    style={{ color: "var(--text-secondary)" }}
                  >
                    Use for non-interactive content blocks. Hover shows neon
                    border + glow.
                  </p>
                </div>
                <div className="-interactive p-5">
                  <div className=" mb-2">Interactive card</div>
                  <p
                    className="text-sm"
                    style={{ color: "var(--text-secondary)" }}
                  >
            ...
            <div>
              <div className=" mb-4">Form inputs</div>
            ...
            <div>
              ...
              <div>
                ...
                <p
                  ...
                  style={{ color: "var(--text-secondary)" }}
                >
                  Use the left neon border + dim background to highlight
                  important supplementary information without overwhelming the
        ...
        <Section title="Spacing & Radius">
          <div className=" p-6">
            <div className=" mb-6">Border radius</div>
