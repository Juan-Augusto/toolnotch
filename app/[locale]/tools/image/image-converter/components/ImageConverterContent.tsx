...
import { ArrowRight, Image as ImageIcon, Crop, Sliders, Minimize2 } from "lucide-react";
...
export default function ImageConverterContent({
  ...
  const relatedTools = [
    ...
    },
    {
      ...
      desc:
        locale === "pt"
          ? "Redimensione fotos por pixel ou proporção em tempo real"
          : locale === "es"
            ? "Redimensiona fotos por píxeles o porcentaje en tiempo real"
            : "Resize images by pixels or percentage in real time",
    ...
    },
    {
      ...
      desc:
        locale === "pt"
          ? "Corte imagens interativamente em proporções livres ou fixas"
          : locale === "es"
            ? "Corta imágenes interactivamente en proporciones libres o fijas"
            : "Crop images interactively in custom or preset ratios",
        ...
        <article className="space-y-6 sm:space-y-8 md:space-y-10 mb-6 sm:mb-8 md:mb-10 max-w-4xl mx-auto">
          ...
          {richContent.whatIs && (
            <section aria-labelledby="what-is-heading">
              ...
              >
                {locale === "pt"
                  ? "O que é o Conversor de Imagens?"
                  : locale === "es"
                    ? "¿Qué es el Conversor de Imágenes?"
          ...
          {richContent.whyItMatters && (
            <section aria-labelledby="why-it-matters-heading">
              ...
              >
                {locale === "pt"
                  ? "Por que converter formatos de imagem?"
                  : locale === "es"
