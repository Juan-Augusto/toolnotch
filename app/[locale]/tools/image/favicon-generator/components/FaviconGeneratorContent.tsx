...
interface FaviconGeneratorContentProps {
  ...
  const relatedTools = [
    {
      ...
      desc:
        locale === "pt"
          ? "Recorte seu logotipo no formato quadrado 1:1 antes de gerar favicons"
          : locale === "es"
            ? "Recorta tu logotipo en formato cuadrado 1:1 antes de generar favicons"
            : "Crop your brand logo into a 1:1 square before generating favicons",
    ...
    },
    {
      ...
      desc:
        locale === "pt"
          ? "Altere a resolução por pixels com alta precisão e nitidez"
          : locale === "es"
            ? "Modifica la resolución por píxeles con alta nitidez y precisión"
            : "Change image dimensions with pixel precision and sharpness",
    ...
    },
    {
      ...
      desc:
        locale === "pt"
          ? "Otimize imagens para web com compressão leve e fundo transparente"
          : locale === "es"
            ? "Optimiza imágenes web con compresión ligera y fondo transparente"
            : "Optimize web pictures with lightweight compression and transparency",
        ...
        <article className="space-y-6 sm:space-y-8 md:space-y-10 mb-6 sm:mb-8 md:mb-10 max-w-4xl mx-auto">
          ...
          {richContent.whatIs && (
            <section aria-labelledby="what-is-heading">
              ...
              >
                {locale === "pt"
                  ? "O que é um Favicon e por que você precisa de vários tamanhos?"
                  : locale === "es"
                    ? "¿Qué es un Favicon y por qué necesitas varios tamaños?"
          ...
          {richContent.whyItMatters && (
            <section aria-labelledby="why-it-matters-heading">
              ...
              >
                {locale === "pt"
                  ? "A Importância do Favicon para Branding e SEO"
                  : locale === "es"
                    ? "La Importancia del Favicon para Branding y SEO"
                    : "The Importance of Favicons for Branding and SEO"}
              </h2>
              <p className="leading-relaxed text-label font-mono text-xs sm:text-sm">
                {richContent.whyItMatters}
              </p>
