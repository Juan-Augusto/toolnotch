...
import { ArrowRight, Image as ImageIcon, Minimize2, Sparkles } from "lucide-react";
...
interface ImageResizerContentProps {
  ...
  const relatedTools = [
    {
      ...
      desc:
        locale === "pt"
          ? "Comprima imagens JPG, PNG, WebP e AVIF com controle de qualidade"
          : locale === "es"
            ? "Comprime imágenes JPG, PNG, WebP y AVIF con control de calidad"
            : "Compress JPG, PNG, WebP and AVIF images with quality control",
    ...
    },
    {
      ...
      desc:
        locale === "pt"
          ? "Transforme imagens PNG em WebP com transparência e até 90% menor"
          : locale === "es"
            ? "Convierte imágenes PNG a WebP con transparencia y hasta un 90% menos peso"
            : "Convert PNG images to WebP with transparency and up to 90% smaller files",
    ...
    },
    {
      ...
      desc:
        locale === "pt"
          ? "Combine fotos e imagens redimensionadas em um documento PDF"
          : locale === "es"
            ? "Combina fotos e imágenes redimensionadas en un documento PDF"
            : "Combine resized photos and images into a single PDF document",
        ...
        <article className="space-y-6 sm:space-y-8 md:space-y-10 mb-6 sm:mb-8 md:mb-10 max-w-4xl mx-auto">
            ...
            <section aria-labelledby="what-is-heading">
              ...
              >
                {locale === "pt"
                  ...
                  : locale === "es"
                    ? "¿Qué es el Redimensionamiento de Imagen?"
          ...
          {richContent.whyItMatters && (
            <section aria-labelledby="why-it-matters-heading">
              ...
              >
                {locale === "pt"
                  ? "Por que Redimensionar Imagens é Importante?"
                  : locale === "es"
                    ? "¿Por Qué Es Importante Redimensionar Imágenes?"
                    : "Why Does Image Resizing Matter?"}
              </h2>
              <p className="leading-relaxed text-label font-mono text-xs sm:text-sm">
                {richContent.whyItMatters}
              </p>
