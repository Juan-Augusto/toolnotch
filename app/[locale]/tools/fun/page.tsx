  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
          {TOOLS.map(tool => (
            <Link key={tool.href} href={tool.href}
              className="bg-tertiary rounded-xl border border-gray-200 p-5 hover:shadow-md hover:border-orange-300 transition-all group">
        ...
        <div className="bg-tertiary rounded-xl border border-gray-200 p-6">
