...
import { ArrowRight, DollarSign, Scale, Calculator } from "lucide-react";
...
export default function PercentageCalculatorContent({
  ...
  faqs,
  locale,
}: PercentageCalculatorContentProps) {
        ...
        <article className="space-y-6 sm:space-y-8 md:space-y-10 mb-6 sm:mb-8 md:mb-10 w-full">
            ...
            <section aria-labelledby="what-is-heading">
              ...
              >
                {locale === "pt"
                  ...
                  : locale === "es"
                    ? "¿Qué es una Calculadora de Porcentaje?"
          ...
          {richContent.whyItMatters && (
            <section aria-labelledby="why-it-matters-heading">
              ...
              >
                {locale === "pt"
                  ? "Por que o Cálculo Correto de Porcentagem Importa?"
                  : locale === "es"
                    ? "¿Por Qué Importa el Cálculo Correcto de Porcentaje?"
                    : "Why Does Accurate Percentage Calculation Matter?"}
              </h2>
              <p className="leading-relaxed text-label font-mono text-xs sm:text-sm">
                {richContent.whyItMatters}
              </p>
