...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: t('metaTitle'), url: '/tools/convert/currency-converter' },
  }
}
...
export default async function CurrencyConverterPage({ params }: Props) {
  ...
  const jsonLd = buildJsonLd(
    webAppSchema(t('title'), '/tools/convert/currency-converter', t('metaDescription'), locale, 'FinanceApplication'),
    faqSchema(faqs),
    breadcrumbSchema([
      { name: 'Home', url: '/' },
