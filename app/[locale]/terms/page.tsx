...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const keywordsByLocale = {
    pt: [
      "ToolNotch termos de uso",
      "termos de serviço",
      "condições de uso",
      "isenção de responsabilidade",
      "ferramentas gratuitas online",
      "direitos autorais ToolNotch",
    ],
    es: [
      "ToolNotch términos de servicio",
      "términos de uso",
      "condiciones de uso",
      "exención de responsabilidad",
      "herramientas gratuitas online",
      "propiedad intelectual ToolNotch",
    ],
    en: [
      "ToolNotch terms of service",
      "terms of use",
      "conditions of use",
      "disclaimer",
      "free online tools terms",
      "intellectual property ToolNotch",
    ],
  };
          ...
          <article className="space-y-10">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p className="leading-relaxed text-label">{t("s3P2")}</p>
              </div>
            </section>
