...
export default function AppFormatSelector({
  format,
  quality,
  maxWidth,
  onFormatChange,
  ...
  return (
    <div className="bg-tertiary border border-zinc-200 rounded-2xl p-5 space-y-5 dark:bg-tertiary dark:border-zinc-700">
      <div>
            ...
            <button
              ...
              className={`flex-1 py-2 px-3 rounded-xl border text-sm font-medium transition-colors ${
                format === f.value
                  ...
                  : 'border-zinc-300 text-zinc-700 hover:border-zinc-400 bg-tertiary dark:border-zinc-600 dark:text-zinc-300 dark:hover:border-zinc-500 dark:bg-gray-700'
              }`}
            >
              {f.label}
            </button>
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-zinc-300 dark:border-zinc-600 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-tertiary dark:bg-tertiary text-gray-900 dark:text-gray-100"
        />
      </div>
    </div>
  )
