...
export default function ToolsSection(props: { TOOLS: Tool[], freeLabel: string }) {
    const { TOOLS, freeLabel } = props
    const [selectedCategory, setSelectedCategory] = useState<number | null>(null)
    const filteredTools = selectedCategory !== null ? TOOLS.filter((group) => group.index === selectedCategory) : TOOLS
    ...
    return (
        <>
        <CategoriesFilter TOOLS={TOOLS} setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />
