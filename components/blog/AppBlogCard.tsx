...
export default async function AppBlogCard({ post, locale }: Props) {
  ...
  return (
    <Link
      ...
      className="block bg-tertiary border border-gray-200 rounded-xl p-5 hover:border-gray-300 hover:shadow-sm transition-all group dark:bg-tertiary dark:border-gray-700 dark:hover:border-gray-600"
    >
      <div className="flex items-center gap-2 mb-3">
        <span
          className={`text-xs font-semibold px-2.5 py-0.5 rounded-full ${categoryColorMap[post.category]}`}
        >
          {categoryLabel}
        </span>
      </div>
