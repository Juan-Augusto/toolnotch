...
export default function AppCitationGenerator({ locale }: Props) {
  ...
  const inputClass = "w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-tertiary dark:bg-tertiary px-3 py-2 text-sm"
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        {citation ? (
          ...
          <div className="p-4 rounded-lg bg-gray-50 dark:bg-tertiary border border-gray-200 dark:border-gray-700 text-sm text-gray-400 italic">
            {t('emptyState')}
          </div>
        )}
      </div>
