    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-tertiary dark:bg-tertiary text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
            ...
            {courses.map((course, idx) => (
              <div key={course.id} className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="flex-1 rounded-lg border border-gray-300 dark:border-gray-600 bg-tertiary dark:bg-tertiary text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                <input
                  type="number"
                  min={1}
                  ...
                  className="w-24 rounded-lg border border-gray-300 dark:border-gray-600 bg-tertiary dark:bg-tertiary text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
                {courses.length > 1 && (
                  <button
