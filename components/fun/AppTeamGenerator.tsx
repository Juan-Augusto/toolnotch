...
const TEAM_ACCENTS = [
  { border: 'border-t-4 border-t-neon', numberBg: 'bg-primary/15 text-primary border-primary/40' },
      ...
      <div className="bg-tertiary border border-border rounded-xl p-5 sm:p-6 shadow-xs space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3 pb-3.5 border-b border-border">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xs sm:text-sm font-semibold px-2.5 py-0.5 rounded-full bg-primary/10 text-primary border border-primary/40">
        ...
        {mode === 'byTeams' && (
          <div className="space-y-1.5 w-full">
            ...
            {teamCountError && participants.length >= 2 ? (
              ...
              <p className="text-xs sm:text-sm text-label mt-1">
                {t('teamCount.hint')}
              </p>
            )}
          </div>
                      ...
                      <div className="flex items-center justify-between gap-2 mb-3.5 pb-2.5 border-b border-border">
                        ...
                        <div className="flex items-center gap-1.5 shrink-0">
                          {smaller ? (
                            ...
                            <span className="text-xs sm:text-sm font-semibold px-2.5 py-1 rounded-md bg-tertiary border border-border text-label">
