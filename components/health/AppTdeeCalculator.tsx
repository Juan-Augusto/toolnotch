...
export default function AppTdeeCalculator({ locale, mode }: Props) {
  ...
  const inputClass =
    'w-full px-3 py-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-tertiary dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm'
                    ...
                    <tr
                      ...
                      className={
                        isHighlighted
                          ...
                          : 'bg-tertiary dark:bg-tertiary even:bg-gray-50 dark:even:bg-gray-700/30'
                      }
                    >
