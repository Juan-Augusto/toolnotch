import AppPollingPlaceOutboundLink from "./AppPollingPlaceOutboundLink";
...
export default function AppPollingPlaceFinderContent({
  intro,
  sections,
  cta,
  ...
  return (
    <div className="space-y-10" style={{ color: "var(--text-secondary)" }}>
      ...
      <section>
        ...
        <div className=" p-5 sm:p-6 mt-6 text-center">
          <p
          ...
          <AppPollingPlaceOutboundLink
            href={TSE_POLLING_PLACE_LOOKUP_URL}
            label={cta.label}
          />
        </div>
      </section>
