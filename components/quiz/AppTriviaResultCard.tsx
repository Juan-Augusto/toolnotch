...
export default function AppTriviaResultCard({ result, quiz, onRetake }: TriviaResultCardProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onRetake}
        className="px-8 py-3 border-2 border-gray-300 text-gray-700 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-tertiary rounded-xl font-semibold hover:bg-gray-50 transition-colors"
      >
        {t('restart')}
      </button>
