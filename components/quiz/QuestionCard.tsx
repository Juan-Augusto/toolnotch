          ...
          <button
            ...
            className={`w-full text-left px-5 py-4 rounded-xl border-2 transition-all duration-150 text-sm font-medium ${
              selectedOption === option.id
                ...
                : 'border-gray-200 bg-white text-gray-700 hover:border-blue-300 hover:bg-blue-50/50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 dark:hover:border-blue-600 dark:hover:bg-blue-900/20'
            }`}
          >
            {option.text}
          </button>
