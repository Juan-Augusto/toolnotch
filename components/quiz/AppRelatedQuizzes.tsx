      ...
      <ul className="grid gap-3 sm:grid-cols-3">
        {picks.map((p) => (
          <li key={p.href}>
            <Link
              href={p.href}
              className="flex h-full flex-col rounded-xl border border-gray-200 bg-tertiary p-4 text-sm font-medium text-gray-900 transition-colors hover:border-blue-300 hover:bg-blue-50/40 dark:border-gray-700 dark:bg-tertiary dark:text-white dark:hover:border-blue-600"
            >
              {p.label}
            </Link>
          </li>
