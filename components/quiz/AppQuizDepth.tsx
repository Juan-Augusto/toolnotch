      ...
      <div>
        ...
        <div className="space-y-2">
          {content.faqs.map((faq, i) => (
            <details
              key={i}
              className="group rounded-xl border border-gray-200 bg-tertiary px-5 py-3.5 dark:border-gray-700 dark:bg-tertiary"
            >
                ...
                <Link
                  ...
                  className={`flex h-full flex-col rounded-xl border p-4 transition-colors ${
                    isCurrent
                      ...
                      : 'border-gray-200 bg-tertiary hover:border-blue-300 hover:bg-blue-50/40 dark:border-gray-700 dark:bg-tertiary dark:hover:border-blue-600'
                  }`}
                >
