...
import AppAdUnit from "./AppAdUnit";
import AppFaqSection, { FaqItem } from "./AppFaqSection";
import AppRelatedContent from "./AppRelatedContent";
import AppAffiliateOffers from "./AppAffiliateOffers";
import AppAffiliateStickyBar from "./AppAffiliateStickyBar";
...
export default function AppToolWrapper({
  title,
  description,
  breadcrumbLabel,
  faqs,
  ...
  const howToSteps =
    !suppressHowToSchema && Array.isArray(richContent?.howToUse)
    ...
    <main className="min-h-screen" style={{ background: "var(--background)" }}>
      ...
      <div className={`${maxWidth ?? "max-w-4xl"} mx-auto px-4 py-8`}>
        ...
        <div className="mb-6 no-print">
          <AppAdUnit slot={adSlot ?? AD_SLOTS.TOOL_TOP} />
        </div>
