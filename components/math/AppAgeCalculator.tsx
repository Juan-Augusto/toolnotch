    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-tertiary dark:bg-tertiary px-3 py-2 text-base"
        />
      ...
      {isValidBirthdate && (
        <div>
          ...
          />
          {futureAge && (
            <div className="mt-3 p-4 rounded-lg bg-gray-50 dark:bg-tertiary border border-gray-200 dark:border-gray-700">
